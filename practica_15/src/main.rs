...
// fn remove_char(s: &mut String, ch: char) {
...
#[derive(Debug)]
pub struct AlignCromosome {
    size: usize,
    genotype: Vec<String>,
}

impl AlignCromosome {
    pub fn new(size: usize, input: Vec<&str>) -> AlignCromosome {
    ...
    pub fn crossover(&mut self, parent2: &mut AlignCromosome, crosspoint: usize) {
...
fn main() {
    ...
    // solver.evolve();
    println!("Hello, world!");
    let mut cro1 = AlignCromosome::new(9, vec!["ADASDAAC", "AADTTC"]);
    let mut cro2 = AlignCromosome::new(9, vec!["ADASDAAC", "AADTTC"]);
    println!("{:#?}\n{}", cro1, cro1.fitness());
    println!("{:#?}\n{}", cro2, cro1.fitness());
    cro1.crossover(&mut cro2, 4);
    println!("{:#?}\n{}", cro1, cro1.fitness());
    println!("{:#?}\n{}", cro2, cro1.fitness());
    // println!("{:#?}", AlignCromosome::new(22, vec!["AGTCATTAATTGCGGTTAG", "CCAATTGTAGTT", "AGCATTCGTAGTT", "GTTCAAGGGAGTT"]));
}
